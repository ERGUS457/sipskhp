...
|
*/
$config['log_threshold'] = 1; // Catat error PHP ke log file (level 1 = Error Messages)
...
|
*/
$config['encryption_key'] = 'SIPSKHP_TERA_S3cur3K3y_M3trol0g1_S1ngkaw4ng_2026!';
...
$config['sess_regenerate_destroy'] = TRUE; // Hancurkan session lama saat ID di-regenerasi (mencegah Session Fixation)
...
$config['cookie_httponly'] 	= TRUE;  // Cookie tidak bisa dibaca oleh JavaScript (mencegah pencurian session via XSS)
